...
class CustomPagination:
    def custom_pagination(
        self, request, model, search_keys, search_type, serializer, query
    ):
...
class CustomPaginationMobileView:
    def custom_pagination_mobile_view(
        self, request, model, search_keys, search_type, serializer, query, user=None
    ):
        """
