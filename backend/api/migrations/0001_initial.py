    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dependencies",
                    models.ManyToManyField(related_name="jobs", to="api.dependency"),
                ),
            ],
            options={
                "db_table": "job",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dependencies",
                    models.ManyToManyField(related_name="tasks", to="api.dependency"),
                ),
                (
                    "job",
                    models.ForeignKey(
                ...
                (
                    "predecessors",
                    models.ManyToManyField(
                        blank=True, related_name="successors", to="api.task"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="resources", to="api.resourcegroup"
            ),
        ),
        migrations.AddField(
            model_name="resource",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["id"], name="custom_fiel_id_00e5b1_idx"),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["id", "field_name"], name="custom_fiel_id_b33a4d_idx"
            ),
        ),
        migrations.AddIndex(
